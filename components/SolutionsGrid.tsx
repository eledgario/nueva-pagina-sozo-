...
const solutions: SolutionCard[] = [
  ...
  },
  {
    ...
    title: 'REGALOS',
    subtitle: 'EJECUTIVOS',
    description: 'Cierra tratos. Regalos de alto impacto con presentación premium que sí se recuerdan.',
  ...
  },
  {
    ...
    description: 'Bodas, fiestas y eventos sociales. Productos únicos con diseño de autor.',
    tag: 'Diseño a Medida',
    tagColor: '#f59e0b',
